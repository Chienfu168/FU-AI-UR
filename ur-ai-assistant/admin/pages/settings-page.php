...
<div class="wrap ur-ai-admin-page">
    ...
    <form method="post" class="ur-ai-admin-form">
        ...
        <div class="ur-ai-card">
            <div class="ur-ai-card-header">
                <div>
                    <h2 class="ur-ai-card-title"><?php echo esc_html__('AI 輔助內容品質控管', 'ur-ai-assistant'); ?></h2>
                    <p class="ur-ai-card-description">
                        <?php echo esc_html__('控制 AI 輔助產生的內容品質門檻，避免內容過於簡略。', 'ur-ai-assistant'); ?>
                    </p>
                </div>
            </div>

            <div class="ur-ai-form-row">
                <label for="admin_chat_min_draft_answer_length"><?php echo esc_html__('AI 對話草稿最低回答字數', 'ur-ai-assistant'); ?></label>
                <input
                    type="number"
                    id="admin_chat_min_draft_answer_length"
                    name="admin_chat_min_draft_answer_length"
                    value="<?php echo esc_attr($admin_chat_min_draft_answer_length); ?>"
                    min="20"
                    max="500"
                    step="10"
                    class="small-text"
