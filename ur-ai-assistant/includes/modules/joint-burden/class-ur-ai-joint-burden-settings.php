...
class UR_AI_Joint_Burden_Settings {
    ...
    public static function default_disclaimer() {
        return '本估算依「新北市」都市更新事業及權利變換計畫作業須知之提列總表與各分項說明之公開公式與費率概算，僅供參考，非主管機關核定金額。臺北市及其他縣市另有各自的提列基準，公式與費率不同，不適用本結果。營建單價表物價基準日為民國112年4月，實際報核時應依當月營造工程物價指數調整。個案認定項目（建築設計費、公共設施、拆遷補償、信託費及都市計畫變更負擔、容積移轉費等）與各項費率之實際認列，仍以新北市都市更新及爭議處理審議會審定為準。';
    }
